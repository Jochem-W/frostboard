...
export default function LeaderboardCard({
  ...
  return (
    <main
      className="relative flex h-[512px] w-[1025px] flex-col bg-gradient-to-r from-blue-500  to-cyan-500 text-5xl font-extralight text-white before:absolute before:right-0 before:top-0 before:h-full before:w-[--width] before:bg-neutral-800"
